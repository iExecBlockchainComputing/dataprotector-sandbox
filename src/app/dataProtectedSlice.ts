...
export const selectFilePath = (state: RootState) => state.dataProtected.filePath
...
export const selectDataType = (state: RootState) => state.dataProtected.dataType
export const { setMemoFilePath, setMemoFile, setMemoEmail, setMemoAge, setMemoName, setMemoDataType } = dataProtectedSlice.actions
